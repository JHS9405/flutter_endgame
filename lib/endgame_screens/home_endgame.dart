...
class ListInfinitySaga extends State<InfinitySaga>{
  ...
  Future<List<InfinityComic>> _getComics() async{
    ...
    var md5D = generateMd5("${now}8d31a6ad6fe5a08e40623d37fa83c953434e7e2e956ec9612feff740b53c18f31150330c");
    var url = "https://gateway.marvel.com/v1/public/series?title=infinity gauntlet&ts=${now}&apikey=956ec9612feff740b53c18f31150330c&hash=${md5D}";
    print(url);
